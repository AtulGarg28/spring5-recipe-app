...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        ...
        log.debug("I am in the Bootstrap Data.");
    }
    ...
    private List<Recipe> getRecipes(){
        ...
        guacRecipe.addIngredient(new Ingredient("ripe avo",new BigDecimal(2),eachUom));
        guacRecipe.addIngredient(new Ingredient("ripe avo",new BigDecimal(2),eachUom));
        guacRecipe.addIngredient(new Ingredient("Koshar salt",new BigDecimal(".5"),teaSpoonUom));
        guacRecipe.addIngredient(new Ingredient("fresh lime juice",new BigDecimal(2),tableSpoonUom));
        guacRecipe.addIngredient(new Ingredient("minced red onion",new BigDecimal(2),teaSpoonUom));
        guacRecipe.addIngredient(new Ingredient("ser rona chills",new BigDecimal(2),eachUom));
