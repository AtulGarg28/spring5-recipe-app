package com.atul.spring5recipeapp.bootstrap;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        guacRecipe.getIngredients().add(new Ingredient("ripe avo",new BigDecimal(2),eachUom, guacRecipe));
        guacRecipe.getIngredients().add(new Ingredient("Koshar salt",new BigDecimal(".5"),teaSpoonUom, guacRecipe));
        guacRecipe.getIngredients().add(new Ingredient("fresh lime juice",new BigDecimal(2),tableSpoonUom, guacRecipe));
        guacRecipe.getIngredients().add(new Ingredient("minced red onion",new BigDecimal(2),teaSpoonUom, guacRecipe));
        guacRecipe.getIngredients().add(new Ingredient("ser rona chills",new BigDecimal(2),eachUom, guacRecipe));
        ...
        tacosRecipe.setDescription("Spicy grilled chicken");
